...
* Website: http://www.hashtagcrm.com
* Date: March 20, 2014
*
* Description:
* A few minor changes to enable infobox support (for a better user experience)
********************************************************************************/
                ...
                if (i >= 0) {
                    do {
                        ...
                        if (bounds.contains(clusters[i].center)) {
                            ...
                            pin.pin._clusterInfo = c;
                            _layer.push(pin.pin);
                            if (pin.infobox)
                                _layer.push(pin.infobox);
                        }
                    }
                    while (i--);
                }
